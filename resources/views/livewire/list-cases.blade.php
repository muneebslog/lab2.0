                                            ...
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    <span
                                                        ...
                                                        <span class="font-medium text-sm text-gray-800 leading-none">
                                        ...
                                        <td class="h-px w-72 whitespace-nowrap">
                                            <div class="px-6 py-3 ">
                                                <span
                                                    ...
                                                    {{ $item->created_at->format('d-m-Y') }}-{{ $item->id }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            ...
                                            <div class="px-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    <span class="text-xs text-gray-500">
                                                        ...
                                                        {{ $countIsResultAdded }}/{{ $totalTests }}</span>
                                                    <div
                                                        ...
                                                        <div class="flex flex-col justify-center overflow-hidden bg-gray-800"
                                                            role="progressbar" style="width: {{ $bar }}%" aria-valuenow="25"
